...
{
    public class StateFluentBuilderApi<TStateModel> where TStateModel : IStateModel
    {
        private readonly IFluentStateMachineBuilder<TStateModel> builder;

        private StateFluentBuilderApi()
        {
        }

        public StateFluentBuilderApi(IFluentStateMachineBuilder<TStateModel> stateMachineBuilder)
        {
