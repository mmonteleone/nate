...
namespace Nate.Tests.Unit.Fluent
{
    public class InitiatesFluentBuilderApiTests : FluentTestBase
    {
        ...
        [Fact]
        public void
            InitiatesFluentBuilderApi_AfterTransition_ValidParms_CallsAfterTransitionOnBuilder_ReturnsApiWithBuilder()
        {
            Action<TransitionEventArgs<StubStateModel>> callback = e => { };
        ...
        [Fact]
        public void
            InitiatesFluentBuilderApi_BeforeTransition_ValidParms_CallsBeforeTransitionOnBuilder_ReturnsApiWithBuilder()
        {
            Action<TransitionEventArgs<StubStateModel>> callback = e => { };
        ...
        [Fact]
        public void
            InitiatesFluentBuilderApi_GloballyTransitionsTo_CallsGloballyTransitionsToOnBuilder_ReturnsApiWithBuilder()
        {
        ...
        [Fact]
        public void
            InitiatesFluentBuilderApi_TransitionsTo_ValidParms_CallsTransitionsToOnBuilder_ReturnsApiWithBuilder()
        {
