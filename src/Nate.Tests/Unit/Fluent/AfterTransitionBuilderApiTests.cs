...
namespace Nate.Tests.Unit.Fluent
{
    public class AfterTransitionBuilderApiTests : FluentTestBase
    {
        ...
        [Fact]
        public void AfterTransitionBuilderApi_BeforeTransition_ValidParms_CallsBeforeTransitionOnBuilder_ReturnsApiWithBuilder()
        {
        ...
        [Fact]
        public void AfterTransitionBuilderApi_GloballyTransitionsTo_CallsGloballyTransitionsToOnBuilder_ReturnsApiWithBuilder()
        {
