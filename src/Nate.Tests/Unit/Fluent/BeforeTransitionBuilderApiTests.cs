...
namespace Nate.Tests.Unit.Fluent
{
    public class BeforeTransitionBuilderApiTests : FluentTestBase
    {
        ...
        [Fact]
        public void BeforeTransitionBuilderApi_AfterTransition_ValidParms_CallsAfterTransitionOnBuilder_ReturnsApiWithBuilder()
        {
        ...
        [Fact]
        public void BeforeTransitionBuilderApi_GloballyTransitionsTo_CallsGloballyTransitionsToOnBuilder_ReturnsApiWithBuilder()
        {
