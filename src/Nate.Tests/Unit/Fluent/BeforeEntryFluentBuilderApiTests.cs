...
namespace Nate.Tests.Unit.Fluent
{
    public class BeforeEntryFluentBuilderApiTests : FluentTestBase
    {
        ...
        [Fact]
        public void
            BeforeEntryFluentBuilderApi_AfterTransition_ValidParms_CallsAfterTransitionOnBuilder_ReturnsApiWithBuilder()
        {
        ...
        [Fact]
        public void
            BeforeEntryFluentBuilderApi_BeforeTransition_ValidParms_CallsBeforeTransitionOnBuilder_ReturnsApiWithBuilder()
        {
            Action<TransitionEventArgs<StubStateModel>> callback = e => { };
        ...
        [Fact]
        public void
            BeforeEntryFluentBuilderApi_GloballyTransitionsTo_CallsGloballyTransitionsToOnBuilder_ReturnsApiWithBuilder()
        {
